...
drivetrain Drivetrain = drivetrain(LeftDriveSmart, RightDriveSmart, 319.19, 385, 240, mm, 1);
...
int rc_auto_loop_callback_Controller1() {
  ...
  while(true) {
    if(RemoteControlCodeEnabled) {
      ...
      // check the Up/Down Buttons status to control ArmLift
      ...
      // check the X/B buttons status to control LadderLift
